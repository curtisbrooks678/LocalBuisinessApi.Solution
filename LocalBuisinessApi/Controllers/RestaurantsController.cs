...
namespace LocalBuisinessApi.Controllers
{
  ...
  public class RestaurantsController : ControllerBase
  {
    ...
    [HttpGet]
    public ActionResult<IEnumerable<Restaurant>> Get([FromQuery]string name, [FromQuery]string address, [FromQuery]string cuisine, [FromQuery]int rating, [FromQuery]bool random)
    {
